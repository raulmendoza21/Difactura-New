...
const navItems = [
  { to: '/dashboard', label: 'Centro operativo', icon: 'M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-4 0h4', roles: null, asesoriaOnly: true },
  { to: '/invoices/upload', label: 'Subir documentos', icon: 'M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12', roles: ['ADMIN', 'CONTABILIDAD', 'EMPRESA_UPLOAD'] },
...
export default function Sidebar({ open, onClose }) {
  ...
  const filtered = navItems.filter((item) => {
    if (item.asesoriaOnly && isEmpresa) return false;
