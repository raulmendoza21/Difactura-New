...
const WARNING_MESSAGE_BY_GROUP = {
  doc_ai_fallback: 'El motor documental utilizo una via complementaria selectiva para resolver partes ambiguas del documento.',
  doc_ai_fallback_error: 'La via complementaria selectiva no estuvo disponible y se mantuvo la mejor lectura principal del documento.',
  region_rescue: 'Se reforzo la lectura de zonas concretas del documento para recuperar informacion util.',
  source_discrepancy: 'El motor comparo varias lecturas del documento y conservo la version mas coherente.',
  ...
  ticket_interpretation: 'El documento se interpreto como ticket o factura simplificada y se priorizo el resumen fiscal frente a los datos de pago.',
